...
request_data = {
    ...
    "config": {
        ...
        "max_researcher_iterations": 2,  # Increased to ensure search happens
        "apiKeys": {"OPENAI_API_KEY": "sk",
                    "PERPLEXITY_API_KEY": "pplx"},
        "search_api": "perplexity",
        "apiBaseUrl": {"OPENAI_API_BASE_URL": "https://api.openai.com/v1"},
        "summarization_model": "openai:gpt-4o",  # Using more capable model
        "research_model": "openai:gpt-4o",  # Using more capable model
