#!/usr/bin/env python3
"""Test FastAPI Deep Research endpoints with Perplexity search engine."""
...
def test_research_with_perplexity():
    """Test research endpoint with Perplexity search engine."""
    request_data = {
    ...
    print(f"\n✅ Perplexity research endpoint passed (status: {data['status']})")
...
if __name__ == "__main__":
    print(f"Testing FastAPI with Perplexity search at {API_BASE}\n")
    test_health()
    test_research_with_perplexity()
